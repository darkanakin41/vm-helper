...
entry_points = {
    'console_scripts': [
        'vmhelper = vmhelper.__main__:console_script'
    ]
}

with io.open('vmhelper/__version__.py', 'r') as f:
    version = re.search(r'^__version__\st*=\s*[\'"]([^\'"]*)[\'"]$', f.read(), re.MULTILINE).group(1)

args = dict(name='darkanakin41-vm-helper',
            version=version,
            description='vm-helper - Simplify Virtual Machine management in CLI !',
            ...
            url='https://github.com/darkanakin41/vm-helper',
            license='MIT',
